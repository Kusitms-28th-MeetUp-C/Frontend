...
const TopNavBar = () => {
  return (
    <div className="flex items-center justify-between bg-white px-8 h-[65px]">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex w-80 h-10 items-center rounded-full bg-[#EBEEF9] px-4">
        ...
        <Link
          to="#"
          className="flex items-center rounded-full h-10 bg-[#EBEEF9] px-10 text-[14px] font-semibold text-[#495565]"
        >
          밋플에 공유하기
        </Link>
        ...
        <div className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-[10px] bg-[#EBEEF9]">
          <FiLogOut className="h-6 w-6 text-[#495565]" />
        </div>
      </div>
    </div>
  );
