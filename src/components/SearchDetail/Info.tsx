...
const InfoItem = ({ children, category }: InfoProps) => {
  return (
...
const Info = () => {
  return (
      ...
      <div className="bg-gray9 w-[22%] rounded-[20px] p-6">
        <div className="mb-7 flex items-center justify-between">
          <div className="text-gray1 text-xl font-bold">템플릿 소개</div>
        ...
        <div className="mb-5 text-[15px] font-medium leading-6 text-black">
          8년차 PM이 기획-개발-디자인 웹 서비스 제작 프로젝트에서 필수적인
          요소를 놓치지 않고 순차적으로 진행하도록 가이드하기위해
          제작하였습니다.
        </div>
